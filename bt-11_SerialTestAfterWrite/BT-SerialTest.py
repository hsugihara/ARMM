...
VERSIONDESCRIPTION = 'version 2024/2/16 : Test serial communication just after writing binary to an ARMM board'
    ...
    while True:
        if state == STATE_POWERON:
            ...
            if pstate == STATE_WAIT4BT11:
                ...
                # End this program because serial communication is establiahed
                print('Serial Communication worked !')
                print('End this test.')
                exit(0)
